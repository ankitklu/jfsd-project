    ...
    <div className="relative min-h-screen text-white">
      ...
      <div className="container mx-auto p-6 relative">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="flex justify-center items-center translate-x-[350px] text-4xl font-bold drop-shadow-lg">
 TRACK ACHIEVEMENTS OF EACH STUDENTS
          </h1>
          <button
              ...
              {students.map((student, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <button
                      onClick={() => handleViewInsights(student.studentId , student.fullName)}
