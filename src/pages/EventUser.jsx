...
const EventUser = () => {
  ...
  const fetchStudents = async () => {
    ...
    try {
      ...
      alert("Failed to fetch student data. Please try again later."); // Error notification
    } finally {
      setLoading(false);
    }
  };

  const handleViewInsights = (studentId, fullName) => {
    navigate(`/eventinsights`, {
      state: { studentId, fullName },
    });
  };
    ...
    <div className="relative min-h-screen text-white">
      ...
      <div className="container mx-auto p-6 relative">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="flex justify-center items-center translate-x-[450px] text-4xl font-bold drop-shadow-lg">
          TRACK EVENTS OF EACH STUDENTS
          </h1>
          <button
                ...
                {students.map((student, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <button
                        onClick={() =>
                          handleViewInsights(student.studentId, student.fullName)
                        }
